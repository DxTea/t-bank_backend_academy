...
class Renderer:
    ...
    Он может отображать текущее слово с пропусками,
    количество оставшихся попыток и виселицу.
    """
    ...
    def render_game(self) -> None:
        ...
        """
        picture_index = len(
            self.hangman_pictures) - self.game.remaining_attempts
        print(
    ...
    def render_game_result(game: HangmanGame) -> None:
        ...
        if game.is_word_guessed:
            print(
                f'Поздравляем, мы выиграли! Загаданное слово было : '
                f'{game.current_word.word}')
        else:
            print(
                f'Жаль, но вы проиграли. Загаданное слово было : '
                f'{game.current_word.word}')
    ...
    @staticmethod
    def render_main_menu(current_category: str,
    ...
    def display_welcome_screen():
        ...
        print("Версия игры: 1.0.0")
        print("Разработчик: Семён Давыдов aka DxTea")
        print("Инструкция: Угадайте слово, не допуская более 7 ошибок.")
        print("Лицензия: MIT")
